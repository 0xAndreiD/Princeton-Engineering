...
class GeneralController extends Controller
{
    ...
    private function inputToJson($input, $caseCount, $user = null){
        ...
        $data['Equipment']['PVModule'] = array('Type' => $input['option-module-type'], 'SubType' => $input['option-module-subtype'], 'Option1' => number_format(floatval($input['option-module-option1']), 2), 'Option2' => $input['option-module-option2'], 'Quantity' => $input['option-module-quantity'], 'Custom' => $input['pv-module-custom'], 'CRC32' => $input['pv-module-crc32'], 'CEC' => (isset($input['pv-module-cec']) && $input['pv-module-cec'] == 1 ? 1 : 0), 'ID' => $input['pv-module-id']);
