...
<div class="content" style="text-align:left">
    <div style="display: flex; justify-content: center;">
        <div>
            <button type="button" class="btn btn-secondary dropdown-toggle mr-5" id="company-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Select Company
            </button>
            <div class="dropdown-menu" aria-labelledby="company-dropdown" style="max-height: 300px; overflow: auto;">
                @foreach($companyList as $company)
                <a class="dropdown-item" href="javascript:companyChange('{{ $company['id'] }}', '{{ $company['company_name'] }}')">{{ $company['company_name'] }}</a>
                @endforeach
            </div>
        </div>
...
@include('admin.sealpos.templatescript')
@endsection