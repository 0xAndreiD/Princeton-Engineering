    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                ...
                <button type="button" class="btn-block-option mr-2" 
                    onclick="copyStanchions()">
                    <i class="fa fa-copy"></i> Copy Stanchions
                </button>
                <button type="button" class="btn-block-option" 
                    onclick="delStanchions()">
                    <i class="fa fa-trash"></i> Delete Stanchions
                </button>
            </div>
            @endif
        </div>
...
@include('standardequipment.stanchion.script')
@endsection