...
<html lang="en">
    <head>
        ...
        <title>Consultant Admin Panel</title>
        ...
        <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed page-header-dark page-header-glass main-content-narrow">
            <nav id="sidebar" aria-label="Main Navigation">
                ...
                <div class="content-side content-side-full bg-black-10 text-center smini-hidden">
                    ...
                    <span class="badge badge-pill badge-danger">Consultant</span>
                </div>
                <!-- END User Info -->
            ...
            <header id="page-header">
                ...
                <div class="content-header">
                    ...
                    <div>
                        ...
                        <!-- Term Link -->
                        <div class="d-inline-block">
                            <a type="button" class="btn btn-dual" href="#" data-toggle="modal" data-target="#modal-terms" onclick="openTerms()">
                                Read Terms
                            </a>
                        </div>
                        <!-- END Terms Link -->
