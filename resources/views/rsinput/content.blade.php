...
<div class="row">
    ...
    <tbody>
        ...
        <tr class="h13" style="display: none;" id="tr-13-{{ $conditionId }}">
            ...
            <td class="iw400-bdr">ft | in</td>
            <td class="w400-yellow-bdr"><input type="text" class="txt-center-align" id="af-13-{{ $conditionId }}"  tabindex="35" value="31.17"></input></td>
        ...
        <tr class="h13" style="display: none;" id="tr-14-{{ $conditionId }}">
            ...
            <td class="iw400-bdr">ft | in</td>
            <td class="w400-yellow-bdr"><input type="text" class="txt-center-align" id="af-14-{{ $conditionId }}"  tabindex="35" value="31.17"></input></td>
            <td class="w400-yellow-bdr"><input type="text" class="txt-center-align" id="ai-14-{{ $conditionId }}"  tabindex="35" value="0.00"></input></td>
            <td class="td-dec-feet right-bdr"><input type="text" class="txt-calced right-bdr" id="a-14-{{ $conditionId }}"  tabindex="-1" value="31.17" readonly></input></td>
            <td><div style="overflow:hidden"></td>
        </tr>
