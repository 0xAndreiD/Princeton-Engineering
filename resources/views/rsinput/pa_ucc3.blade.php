            ...
            <div class="col-12">
                <table id="permit-info-table" cellspacing="0" cellpadding="0" style="border-spacing:0;" >    
                    <tbody>
                        ...
                        <tr class="h13">
                            <td class="iw400-right-bdr">Total Fees OWED($)</td>
                            <td class="w400-yellow-bdr"><input type="text" class="permit txt-fee-5" id="txt-fee-5" placeholder="Enter values" tabindex="20" value=""></input></td>
                        </tr>
