@extends((Auth::user()->userrole == 2)? 'admin.layout': ((Auth::user()->userrole == 1 || Auth::user()->userrole == 3) ? 'clientadmin.layout' : (Auth::user()->userrole == 4 ? 'reviewer.layout' : ((Auth::user()->userrole == 6) ? 'consultant.layout' : ((Auth::user()->userrole == 6) ? 'consultant.layout' : 'user.layout')))))
