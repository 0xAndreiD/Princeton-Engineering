            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: left;">
							...
							<h3 style="margin: 0px 0px 0px 0px; color: black;">	Number:		{{$projectNumber}}</h3>
							<h3 style="margin: 0px 0px 0px 0px; color: black;">	Name:		{{$projectName}}</h3>
							<h3 style="margin: 0px 0px 0px 0px; color: black;">	State:		{{$state}}</h3>
            			</div>
            		</td>
            	</tr>
            </table>
					...
					<tr>
						<td>
							<div class="text" style="padding: 0 2.5em; text-align: left;">
								...
								<h3 style="margin: 0px 0px 0px 0px; color: black;">Admin just updated the chat on this project</h3>
							</div>
						</td>
					</tr>
				</table>
