      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
        ...
        <tr>
			<td style="text-align:center; width: 100%; font-size: 20px; color: black; padding-top: 10px;" class="hero bg_white">
				Your payment to Princeton Engineering was {{ $success ? 'successful' : 'failed' }}.
			</td>
		</tr>

        <tr>
			<td style="text-align:center; width: 100%; font-size: 16px; color: black; padding-top: 10px;" class="hero bg_white">
                @if($success)
				We're writing to let you know that your {{ $date }} Princeton Engineering payment(I-{{ $invoicenumber }}), for company {{ $company->company_number }}. {{ $company->company_name }}, has processed successfully. A total of ${{ $amount }} was charged to your card ************{{ $cardnumber }}. The invoice and receipt is attached to this email.
                @else
                We're writing to let you know that your {{ $date }} Princeton Engineering payment(I-{{ $invoicenumber }}), for company {{ $company->company_number }}. {{ $company->company_name }}, has failed. The unpaid invoice is attached to this email.
                @endif
			</td>
		</tr>
        @if(!$success)
                  ...
                  <tr>
                      <td>
                          <div class="text" style="padding: 0 2.5em; text-align: left;">
                              ...
                              <h3 style="margin: 0px 0px 0px 50px; color: black;">	Amount:		{{$amount}}</h3>
