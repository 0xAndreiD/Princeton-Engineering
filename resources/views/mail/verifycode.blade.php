            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: center;">
            				<h2 style="color: black;">Your IP Address: {{$ip}}</h2>
                    		<h3 style="color: black;">If yes, use this verification code:</h3>
            				<h1 style="color: black;">{{$code}}</h1>
                    		<p style="color: black;">This code expires in 10 minutes.</p>
            			</div>
            		</td>
            	</tr>
            </table>
